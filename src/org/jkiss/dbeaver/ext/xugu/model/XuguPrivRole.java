 ...
 * OraclePrivRole
 */
public class XuguPrivRole extends XuguPriv implements DBSObjectLazy<XuguDataSource> {
    private Object role;
    ...
    public Object getRole(DBRProgressMonitor monitor) throws DBException
    {
        ...
        return XuguUtils.resolveLazyReference(monitor, getDataSource(), getDataSource().roleCache, this, null);
    }
