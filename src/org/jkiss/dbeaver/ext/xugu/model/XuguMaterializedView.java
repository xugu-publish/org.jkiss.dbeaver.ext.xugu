...
public class XuguMaterializedView extends XuguSchemaObject implements XuguSourceObject, DBSObjectLazy<XuguDataSource>
{
    ...
    public XuguMaterializedView(XuguSchema schema, String name)
    {
        super(schema, name, false);
    }

    public XuguMaterializedView(
        XuguSchema schema,
        ResultSet dbResult)
    {
        super(
    ...
    {
        return XuguSourceType.MATERIALIZED_VIEW;
    }
    ...
    public DBEPersistAction[] getCompileActions()
    {
        return new DBEPersistAction[] {
            new XuguObjectPersistAction(
                XuguObjectType.MATERIALIZED_VIEW,
