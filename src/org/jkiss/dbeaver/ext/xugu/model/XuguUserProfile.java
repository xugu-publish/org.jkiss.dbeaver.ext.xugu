 ...
 * OracleUserProfile
 */
public class XuguUserProfile extends XuguGlobalObject
{
    private static final Log log = Log.getLog(XuguUserProfile.class);

    private String name;
    private List<ProfileResource> resources;

    public XuguUserProfile(XuguDataSource dataSource, ResultSet resultSet) {
     ...
     * ProfileResource
     */
    public static class ProfileResource extends XuguObject<XuguUserProfile>
    {
        ...
        public ProfileResource(XuguUserProfile profile, ResultSet resultSet) {
