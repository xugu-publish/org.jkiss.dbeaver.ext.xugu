...
public enum XuguParameterMode {
    ...
    XuguParameterMode(DBSProcedureParameterKind parameterKind)
    {
        this.parameterKind = parameterKind;
    }

    public static XuguParameterMode getMode(String modeName)
    {
        if (CommonUtils.isEmpty(modeName)) {
            ...
            return XuguParameterMode.OUT;
        } else {
            return XuguParameterMode.INOUT;
        }
    }
