 ...
 * GenericProcedure
 */
public class XuguProcedurePackaged extends XuguProcedureBase<XuguPackage> implements DBPUniqueObject
{
    private Integer overload;

    public XuguProcedurePackaged(
        XuguPackage ownerPackage,
        ResultSet dbResult)
    {
        super(ownerPackage,
