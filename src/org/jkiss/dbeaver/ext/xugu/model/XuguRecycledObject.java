 ...
 * Recycled object
 */
public class XuguRecycledObject extends XuguSchemaObject implements DBSObjectLazy<XuguDataSource> {
    ...
    protected XuguRecycledObject(XuguSchema schema, ResultSet dbResult)
    {
