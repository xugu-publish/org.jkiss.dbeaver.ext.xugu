 ...
 * Oracle sequence
 */
public class XuguQueue extends XuguSchemaObject {

    private static final Log log = Log.getLog(XuguQueue.class);
    ...
    public XuguQueue(XuguSchema schema, String name) {
        super(schema, name, false);
    }

    public XuguQueue(XuguSchema schema, ResultSet dbResult) {
    ...
    public XuguTableBase getQueueTable(DBRProgressMonitor monitor) throws DBException {
