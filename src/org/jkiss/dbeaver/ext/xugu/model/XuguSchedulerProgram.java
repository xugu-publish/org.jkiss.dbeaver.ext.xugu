...
/**
 * Xugu scheduler program
 */
public class XuguSchedulerProgram extends XuguSchemaObject {
    ...
    XuguSchedulerProgram(XuguSchema schema, ResultSet dbResult) {
    ...
    @Association
    public Collection<XuguSchedulerProgramArgument> getArguments(DBRProgressMonitor monitor) throws DBException
    {
        return argumentsCache.getAllObjects(monitor, this);
    }

    static class ArgumentsCache extends JDBCObjectCache<XuguSchedulerProgram, XuguSchedulerProgramArgument> {

        @Override
        protected JDBCStatement prepareObjectsStatement(@NotNull JDBCSession session, @NotNull XuguSchedulerProgram program) throws SQLException
        {
        ...
        @Override
        protected XuguSchedulerProgramArgument fetchObject(@NotNull JDBCSession session, @NotNull XuguSchedulerProgram program, @NotNull JDBCResultSet resultSet) throws SQLException, DBException
        {
            return new XuguSchedulerProgramArgument(program, resultSet);
        }
