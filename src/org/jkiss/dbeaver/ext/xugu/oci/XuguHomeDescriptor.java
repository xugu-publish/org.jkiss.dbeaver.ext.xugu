...
import org.jkiss.dbeaver.ext.xugu.XuguDataSourceProvider;
...
public class XuguHomeDescriptor extends LocalNativeClientLocation
{
    private static final Log log = Log.getLog(XuguHomeDescriptor.class);

    private Integer oraVersion; // short version (9, 10, 11...)
    private String displayName;
    private List<String> tnsNames;

    public XuguHomeDescriptor(String oraHome)
    {
        super(CommonUtils.removeTrailingSlash(oraHome), oraHome);
        this.oraVersion = XuguDataSourceProvider.getOracleVersion(this);
        if (oraVersion == null) {
