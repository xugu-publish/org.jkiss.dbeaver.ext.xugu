...
package org.jkiss.dbeaver.ext.xugu.oci;
...
public class OCIUtils
{
     ...
     */
    private static final List<XuguHomeDescriptor> oraHomes = new ArrayList<>();
...
*/
    ...
    public static List<XuguHomeDescriptor> getOraHomes()
    {
        checkOraHomes();
        return oraHomes;
    }
    ...
    public static XuguHomeDescriptor getOraHome(String oraHome) {
        if (CommonUtils.isEmpty(oraHome) || !checkOraHomes()) {
            return null;
        }
        for (XuguHomeDescriptor home : oraHomes) {
    ...
    public static XuguHomeDescriptor getOraHomeByName(String oraHomeName) {
    ...
    public static XuguHomeDescriptor addOraHome(String oraHome) throws DBException
    {
        ...
        if (!contains) {
            XuguHomeDescriptor homeDescriptor = new XuguHomeDescriptor(oraHome);
    ...
    private static void findOraHomes()
    {
        ...
        String path = System.getenv(XuguConstants.VAR_PATH);
        if (path != null) {
        ...
        String oraHome = System.getenv(XuguConstants.VAR_ORA_HOME);
        if (oraHome == null) {
            oraHome = System.getenv(XuguConstants.VAR_ORACLE_HOME);
        }
        if (oraHome != null) {
            try {
                addOraHome(oraHome);
...
*/
    ...
    public static File findTnsNamesFile(@Nullable File oraHome, boolean checkTnsAdmin)
    {
        ...
        if (checkTnsAdmin) {
            String tnsAdmin = System.getenv(XuguConstants.VAR_TNS_ADMIN);
            if (tnsAdmin != null) {
