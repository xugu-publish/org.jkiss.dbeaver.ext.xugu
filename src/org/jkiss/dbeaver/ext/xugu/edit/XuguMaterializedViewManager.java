...
import org.jkiss.dbeaver.ext.xugu.model.XuguMaterializedView;
...
public class XuguMaterializedViewManager extends SQLObjectEditor<XuguMaterializedView, XuguSchema> {
    ...
    @Override
    protected XuguMaterializedView createDatabaseObject(DBRProgressMonitor monitor, DBECommandContext context, XuguSchema parent, Object copyFrom)
    {
        XuguMaterializedView newView = new XuguMaterializedView(parent, "NewView"); //$NON-NLS-1$
        return newView;
    }
    ...
    private void createOrReplaceViewQuery(List<DBEPersistAction> actions, XuguMaterializedView view)
    {
