...
public class XuguSessionEditor extends AbstractSessionEditor
{
    ...
    private class DisconnectSessionAction extends Action {
        ...
        {
            super(
                kill ? XuguMessages.editors_xugu_session_editor_title_kill_session : XuguMessages.editors_xugu_session_editor_title_disconnect_session,
        ...
        public void run()
        {
            ...
            final String action = (kill ? XuguMessages.editors_xugu_session_editor_action_kill : XuguMessages.editors_xugu_session_editor_action_disconnect) + XuguMessages.editors_oracle_session_editor_action__session;
            ConfirmationDialog dialog = new ConfirmationDialog(
                getSite().getShell(),
                action,
                null,
                NLS.bind(XuguMessages.editors_xugu_session_editor_confirm_action, action.toLowerCase(), sessions),
                MessageDialog.CONFIRM,
                new String[] { IDialogConstants.YES_LABEL, IDialogConstants.NO_LABEL },
                0,
                XuguMessages.editors_xugu_session_editor_confirm_title,
                false);
