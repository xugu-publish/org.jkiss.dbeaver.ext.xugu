 ...
 */
public class SchedulerJobLogEditor extends AbstractDataEditor<XuguSchedulerJob>
{
    ...
    protected DBDDataFilter getEditorDataFilter() {
        XuguSchedulerJob job = getDatabaseObject();
        XuguTableBase logView = getJobLogView();
        if (logView == null) {
            return null;
        }
        ...
        try {
            ...
            XuguTableColumn ownerAttr = logView.getAttribute(monitor, "OWNER");
            if (ownerAttr != null) {
            ...
            XuguTableColumn logDateAttr = logView.getAttribute(monitor, "LOG_DATE");
            if (logDateAttr != null) {
    ...
    private XuguTableBase getJobLogView() {
        DBRProgressMonitor monitor = new VoidProgressMonitor();

        try {
            XuguDataSource dataSource = getDatabaseObject().getDataSource();
            XuguSchema systemSchema = dataSource.getSchema(monitor, XuguConstants.SCHEMA_SYS);
