...
public class XuguCompilerDialog extends BaseDialog
{
    ...
    {
        super(shell, XuguMessages.views_xugu_compiler_dialog_title, null);
    ...
    protected Composite createDialogArea(Composite parent)
    {
...

        {
            ...
            ViewerColumnController columnController = new ViewerColumnController("XuguCompilerDialog", unitTable);
            columnController.addColumn(XuguMessages.views_xugu_compiler_dialog_column_name, null, SWT.NONE, true, true, new CellLabelProvider() {
                @Override
            ...
            columnController.addColumn(XuguMessages.views_xugu_compiler_dialog_column_type, null, SWT.NONE, true, true, new CellLabelProvider() {
                @Override
                public void update(ViewerCell cell)
                {
                    DBSObject unit = (DBSObject) cell.getElement();
    ...
    protected void createButtonsForButtonBar(Composite parent)
    {
        ...
        createButton(parent, COMPILE_ID, XuguMessages.views_xugu_compiler_dialog_button_compile, false).setEnabled(false);
		createButton(parent, COMPILE_ALL_ID, XuguMessages.views_xugu_compiler_dialog_button_compile_all, true);
    ...
    private void performCompilation(DBRProgressMonitor monitor, List<XuguSourceObject> units)
    {
        ...
        for (XuguSourceObject unit : units) {
            ...
            final String message = NLS.bind(XuguMessages.views_xugu_compiler_dialog_message_compile_unit, unit.getSourceType().name(), unit.getName());
            ...
            compileLog.info(!success ? XuguMessages.views_xugu_compiler_dialog_message_compilation_error : XuguMessages.views_xugu_compiler_dialog_message_compilation_success);
