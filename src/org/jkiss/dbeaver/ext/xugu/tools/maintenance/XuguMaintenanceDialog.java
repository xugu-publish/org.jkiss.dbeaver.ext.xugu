 ...
 * Table truncate
 */
public abstract class XuguMaintenanceDialog<T extends DBSObject> extends GenerateMultiSQLDialog<T>
{

    public XuguMaintenanceDialog(IWorkbenchPartSite partSite, String title, Collection<T> objects) {
